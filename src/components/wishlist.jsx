...
const Wishlist =()=>{
	...
	const getallwishData = ()=>{
        axios.get(`https://e-commbackend-fast-api.vercel.app/wishlist/wishlist/${userid}`).then((response)=>{
	...
	const wishDelete = (data)=>{
		axios.delete(`https://e-commbackend-fast-api.vercel.app/wishlist/deletewish/${data}`).then((response)=>{
			getallwishData();
        })
	}
